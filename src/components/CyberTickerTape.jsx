...
export default function CyberTickerTape({ 
  ...
  return (
    <div className={`relative overflow-hidden py-3 font-mono-code text-xs font-black tracking-widest uppercase select-none ${bgClass}`}>
      <motion.div
