...
import { Eye, Bell, BarChart3, FileText, Clock, Shield } from 'lucide-react';
  ...
  return (
    <ServicePageLayout
      ...
      features={[
        ...
        { icon: <Clock className="w-5 h-5" />, title: 'Sub-15 Min Triage Escalation', desc: 'Context-rich incident tickets with clear remediation steps dispatched instantly to your engineering team.' },
